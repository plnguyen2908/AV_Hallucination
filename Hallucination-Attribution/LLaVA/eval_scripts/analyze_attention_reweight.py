...
def eval_model(args):
    ...
    for (input_ids, image_tensor, image_sizes), line in tqdm(zip(data_loader, questions), total=len(questions)):
        ...
        model.config.reweight_text = args.reweight_text
        model.config.reweight_img = args.reweight_img
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reweight_text", action='store_true', default=False)
    parser.add_argument("--reweight_img", action='store_true', default=False)
