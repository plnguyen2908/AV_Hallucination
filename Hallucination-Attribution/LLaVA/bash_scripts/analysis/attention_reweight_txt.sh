...
# Figure 6(a): analyze the effect of downscaling the text attention of hallucination heads
for reweight_alpha in 1.0 0.8 0.6 0.4 0.2 0.0
do
dataset=coco
top_k=20
result_path=./results/$dataset/halheads_reweight_text_top${top_k}_${reweight_alpha}
