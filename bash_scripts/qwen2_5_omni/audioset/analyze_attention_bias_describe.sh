...
ATTENTION_HEAD_PATH="$ROOT_DIR/results/qwen2_5_omni/AudioSet_describe/attribution/heads/attribution_result.json"
OUTPUT_PATH="$ROOT_DIR/results/qwen2_5_omni/AudioSet_describe/attention_bias"
TOP_K=20
