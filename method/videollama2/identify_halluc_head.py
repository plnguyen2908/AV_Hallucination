...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", type=str, default="/nobackup/le/AV_Hallucination/data/AVHBench/sampled_entities.json")
    ...
    parser.add_argument("--output_path", type=str, default="/nobackup/le/AV_Hallucination/data/AVHBench/attribution")
